...
Diese Anleitung ist für Entwickler. Wer die Mod nur spielen möchte, braucht später das fertige Release-Paket, nicht diese Schritte.

## Voraussetzungen

- Windows x64 und eine eigene Installation von Dungeon Settlers **DS_B.0.4.17 / Steam 25143510**.
...
Der Quellcode bleibt bei Version **0.3.6** und prüft weiterhin die Fingerabdrücke des unterstützten Spielbuilds. Ändere diese Prüfung nicht einfach, um ein unbekanntes Spielupdate freizuschalten; dafür müssen die Schnittstellen und das Verhalten erneut geprüft werden.
