# Extended Hotbar Helper — development

The maintained developer documentation is in [README.md](README.md). It covers build requirements, tests, package preparation, the safety model and technical limitations.

- [Build and tests](README.md#build-and-tests)
- [Safety model and limitations](README.md#safety-model-and-limitations)
- [Package preparation](README.md#package)
